...
#include <stdbool.h>
#include <stdint.h>
typedef struct {uint16_t motor_steps_per_rev,microsteps,motor_run_current_mA,motor_hold_current_mA;float screw_pitch_mm,manual_speed_mm_s,acceleration_mm_s2;} motor_config_t;
