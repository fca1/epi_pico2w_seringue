...
#include <stdbool.h>
#include <stdint.h>
typedef struct {uint16_t motor_steps_per_rev,microsteps,motor_run_current_mA,motor_hold_current_mA;float screw_pitch_mm,manual_speed_mm_s,a1_mm_s2,amax_mm_s2,dmax_mm_s2,d1_mm_s2;} motor_config_t;
...
uint32_t motor_acceleration_to_tmc(const motor_config_t*,float mm_s2);
...
bool motor_set_position_mm(float mm);
